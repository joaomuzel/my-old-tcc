...
if(!isset($_SESSION['login']) && (!isset($_SESSION['senha']))){
    header("Location: Letra.php?acao=negado");exit;
}
...
?>
 ...
 <?php
    ...
    $select = "SELECT * from musica WHERE idmusica=:idmusica LIMIT 1";
                  $contagem =1;
                    try{
                      $resultado = $conexao->prepare($select);
                      $resultado -> bindParam('idmusica', $Url, PDO::PARAM_INT);
                      $resultado->execute();
...
<?php
                            ...
                            if(!$_SESSION['login_email']){
                                session_destroy;
                                header("location: Letras.php?msg=logado");
                            }
    ...
    <ul class="slides">
      ...
      <li>
        ...
        <div class="container">
              ...
              <h5><b><?php echo $exibe->autor; ?> </b> - <b><?php echo $exibe->titulo; ?></b></h5>
