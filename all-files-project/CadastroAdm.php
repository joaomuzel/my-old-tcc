<!DOCTYPE html>
  <html>
    ...
    <title>Cadastro de ADM - Divulga Músicas</title>
    ...
    <div class="nav-wrapper container">
      <a href="Home.php" class="brand-logo center">Divulga Músicas - ADM</a>
      <a href="#" data-activates="menu-mobile" class="button-collapse right">
        ...
        <div class="container">
            ...
            <div class="row">
    <form class="col s12" action="php/Sistema_adm.php" method="post">
      <div class="row">
   ...
   <button class="btn waves-effect waves-light" type="submit" name="action">CAdastrar
    ...
    <i class="material-icons right">delete</i>
         ...
         <a href="LoginAdm.php" target="blank">Para logar, clique aqui.</a>
        </div>
        <br>
