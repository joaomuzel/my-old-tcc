<!DOCTYPE html>
  <html>
    ...
    <title>Cadastro de Compositores - Divulga Músicas</title>
    ...
    <div class="nav-wrapper container">
      <a href="Home.php" class="brand-logo center">Divulga Músicas - Compositor</a>
    ...
    <div class="row">
    <form class="col s12" action="php/Sistema_compositor.php" method="post">
      <div class="row">
        <div class="input-field col s6">
            <i class="material-icons prefix">account_circle</i>
          <input placeholder="Nome" id="first_name" type="text" class="validate" name="nome">
          <label for="first_name">Nome Artístico</label>
        </div>
      </div>
        <div class="row">
        <div class="input-field col s6">
   ...
   <button class="btn waves-effect waves-light" type="submit" name="action">CAdastrar
    ...
    <i class="material-icons right">delete</i>
         ...
         <a href="LoginComp.php" target="blank">Para logar, clique aqui.</a>
        </div>
        <br>
