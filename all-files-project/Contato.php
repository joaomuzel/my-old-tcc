...
<!DOCTYPE html>
  <html>
    ...
    <title>Contato - Divulga Músicas</title>
    ...
    <div class="nav-wrapper container">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="Cadastro.php">Cadastro</a></li>
          ...
          <li class="active"><a class="grey-text text-lighten-3" href="Contato.php">Contato</a></li>
    ...
    <ul class="slides">
      ...
      <li>
        ...
        <div class="container">
            ...
            <div class="card-panel #03a9f4 light-blue"><i class="material-icons left">check_circle</i><b>Mensagem enviado com sucesso!!.</b></div>
            <?php }else{ ?>
            <h1>Contato: </h1>
        
            
            <div class="row">
    <form class="col s12"  action="php/enviarEmail.php" method="post">
      <div class="row">
