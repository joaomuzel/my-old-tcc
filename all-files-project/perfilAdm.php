...
<!DOCTYPE html>
    ...
    <div class="nav-wrapper container">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Músicas<i class="material-icons right">arrow_drop_down</i></a></li>
          <li class="active"><a class="dropdown-button" href="#!" data-activates="usuario"><?php echo $nome; ?><i class="material-icons right">arrow_drop_down</i></a></li>
      </ul>
        
        <!-- Dropdown usuario -->
        <ul id="usuario2" class="dropdown-content">
          <li><a href="perfilAdm.php">Perfil</a></li>
          <li><a href="?sair" onClick="return confirm('Deseja mesmo sair?')">Sair</a></li>
        </ul>
  ...
  ?>
            ...
            <div id="pos">
            <h4><b>Nome:</b> <?php echo $nome; ?></h4>
            <h4><b>Email:</b> <?php echo $email; ?></h4>
            <h4><b>CPF: </b><?php echo $cpf; ?></h4>
            </div><br><br>
            <a href="CadastroCategorias.php"  target="blank" class="waves-effect waves-light btn-large" id="bot">
            <i class="material-icons right">add</i>Cadastrar Nova Categoria de músicas</a><br><br>
            <br>
            
            <a href="ListarUsuarios.php"  target="blank" class="waves-effect waves-light btn-large" id="bot">
            <i class="material-icons right">delete</i>Excluir Usuários</a><br><br>
            <br>
            
            <a href="ListarCompositores.php"  target="blank" class="waves-effect waves-light btn-large" id="bot">
            <i class="material-icons right">delete</i>Excluir Compositores</a><br><br>
            <br>
            
            <a href="ListarCategorias.php"  target="blank" class="waves-effect waves-light btn-large" id="bot">
            <i class="material-icons right">delete</i>Excluir Categorias</a><br><br>
            <br>
            <!--
