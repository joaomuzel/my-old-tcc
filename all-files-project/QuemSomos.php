<!DOCTYPE html>
  <html>
    ...
    <title>Quem Somos? - Divulga Músicas</title>
    ...
    <div class="nav-wrapper container">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li class="active"><a href="QuemSomos.php">Sobre</a></li>
          <!-- Dropdown Trigger -->
    ...
    <ul class="slides">
      ...
      <li>
        ...
        <div class="container">
          <h1>Quem Somos??</h1>
            <p><b>Divulga Músicas</b>, veio pra questionar e ampliar os conceitos sobre venda de músicas autorais pela internet, a gente quer inspirar em músicos independentes a serem livres para se sentirem mais valorizados e reconhecido no seu trabalho, pois a música também é uma profissão.</p>
            <p>Hoje em dia, para os músicos, a divulgação via internet, utilizando as mídias sociais ou coisa do tipo, é de grande número, pois a maneira de fazer marketing hoje, é diferente. Uma das principais formas de um músico/compositor gerar renda, é vendendo sua música em forma digital, e só se faz isso divulgando a mesma, e para um músico/compositor musical independente vender sua música, principalmente no Brasil, sem o suporte de uma gravadora, é muito difícil. </p>
            <p>Por mais que existam serviços como a ONErpm ou a CD Baby, que distribuem músicas de artistas pelas maiores plataformas digitais do mundo, entre elas o Spotify, Deezer e iTunes, existem formas de um músico/compositor, divulgar sua música de forma gratuita, e ainda conseguir ter um bom reconhecimento do público alvo dele.</p>
            <p>E com o passar dos anos, foram poucas as ferramentas gratuitas, que permitissem o músico/compositor divulgar sua música. Então, se teve a ideia de um site que ajude músicos/compositores independentes a divulgarem suas músicas autorais, para que alguém se interesse e entre em contato para negócios.</p>
            <br>
        </div>
        <br>
