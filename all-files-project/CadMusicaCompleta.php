...
<!DOCTYPE html>
  <html>
    ...
    <title>Cadastro de Músicas completas - Divulga Músicas</title>
...
$insert = "INSERT into musicacompleta (titulo, autor, data, letra, musica_demo, fins, genero) VALUES (:titulo, :autor, :data, :letra, :musica_demo, :fins, :genero)";
	 ...
	 ?>
        ...
        <br>
        <div class="container">
            <h1>Cadastre sua música (Completa):</h1>
